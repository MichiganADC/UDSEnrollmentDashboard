  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem(tabName = "summary",
              ...
              fluidRow(
                valueBox(
                  value = as.integer(summ_tbl[summ_tbl$uds_dx == "Totals", "Total"]),
                  subtitle = "Total Enrolled",
                  icon = icon("dashboard"),
                  color = "navy"),
                valueBox(
                  value = as.integer(summ_tbl[summ_tbl$uds_dx == "Totals", "Blood Drawn Yes"]),
                  subtitle = "Blood Drawn",
                  icon = icon("tint"),
                  color = "navy"),
                valueBox(
                  value = as.integer(summ_tbl[summ_tbl$uds_dx == "Totals", "MRI Yes"]),
                  subtitle = "MRI Completed",
                  icon = icon("magnet"),
                  color = "navy")
              ),
              fluidRow(
